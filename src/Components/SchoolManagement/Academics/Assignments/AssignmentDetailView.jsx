...
const AssignmentDetailView = () => {
    ...
    const [formData, setFormData] = useState({
        assignmentId: assignmentId, staffId: "", staffName: "", assignmentName: '', assignmentType: '', subject: '', class: '', section: '', dueDate: dates, description: '', points: '', status: "Active"
    });
    ...
    const getAssignmentDetail = async () => {
        const url = `http://localhost:5000/api/assignment/${assignmentId}`
        const options = {
            method: "GET",
        }
        ...
        try {
            ...
            const data = responseData.assignment[0]
            console.log(data)
            setFormData((prev) => ({
                ...prev,
                    ...
                    <FormContainer>
                        ...
                        <Forms onSubmit={handleSubmit}>
                            <InputElements>
                                ...
                                <InputContainer>
                                    <Input name="points" value={formData.points} onChange={handleChange} type="text" id="points" required />
