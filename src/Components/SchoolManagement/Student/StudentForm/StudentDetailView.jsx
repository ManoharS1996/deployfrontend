...
const StudentDetailView = () => {
    ...
    const [formData, setFormData] = useState({
        fullName: '', studentId: studentId, gender: '', dateOfBirth: dates, nationality: { id: "101", emoji: "🇮🇳", name: 'India' }, state: { id: '', name: '', state_code: '' }, city: '', street: '', pinCode: '', status: 'Active',
    ...
    const getStudentDetail = async () => {
        ...
        try {
            ...
            setFormData((prev) => ({
                ...
                dateOfBirth: data.student_date_of_birth,
                nationality: {
                    id: data.student_nationality.student_nationality_id,
                    emoji: data.student_nationality.student_nationality_emoji,
                    name: data.student_nationality.student_nationality_name
                },
                state: {
                    id: data.student_state.student_state_id,
                    name: data.student_state.student_state_name,
                    state_code: data.student_state.student_state_code
                },
                city: data.student_city,
                street: data.student_street,
                ...
                nameOfPreviousSchool:data.student_previous_school,
                 lastGrade: data.student_last_grade,

                class: data.student_class,
                 section:data.student_section,
                  roll: data.student_roll,
                   prefferedDate:data.student_preffered_date,
        ...
        <MainContainer>
            ...
            <BottomContainer>
                ...
                <StudentFormContainer>
                    <FormContainer>
                        <TopContainer formname='Student Detail View' fun={onClose} />
                            ...
                            <InputElements>
                                ...
                                <InputContainer>
                                    <CountrySelect style={inputStyle} name="nationality"
                                        ...
                                        placeHolder="Nationality" type="text" id="nation" />
                                </InputContainer>
