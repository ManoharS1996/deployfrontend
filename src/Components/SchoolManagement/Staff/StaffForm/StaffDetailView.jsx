...
const StaffDetailView = () => {
    ...
    const [formData, setFormData] = useState({
        employeeId: '', employeeName: '', gender: '', dateOfBirth: dates, nationality: { id: "101", emoji: "🇮🇳", name: 'India' }, state: { id: '', name: '', state_code: '' },
        city: '', street: '', pinCode: '', status: 'Active',
    ...
    const getStudentDetail = async () => {
        const url = `http://localhost:5000/api/staff/${staffId}`
        const options = {
            method: "GET",
        }
        ...
        try {
            ...
            setFormData((prev) => ({
                ...
                dateOfBirth: data.staff_date_of_birth,
                status: data.staff_status,
                nationality: {
                    id: data.staff_nationality.staff_nationality_id,
                    emoji: data.staff_nationality.staff_nationality_emoji,
                    name: data.staff_nationality.staff_nationality_name
                },
                state: {
                    id: data.staff_state.staff_state_id,
                    name: data.staff_state.staff_state_name,
                    state_code: data.staff_state.staff_state_code
                },
                city: data.staff_city,
                street: data.staff_street,
                pinCode: data.staff_pincode,

                employeeContact: data.staff_contact,
                employeeEmail: data.staff_email,
                jobTitle: data.staff_title,
                department: data.staff_department,
                highestDegree: data.staff_degree,
                previousWork: data.staff_work,
                certifications: data.staff_certificates,
        ...
        <MainContainer>
            ...
            <BottomContainer>
                ...
                <StudentFormContainer>
                    <FormContainer>
                        <TopContainer formname='Staff Detail View' fun={onClose} />
