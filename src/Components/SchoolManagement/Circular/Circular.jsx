...
const Circular = () => {
    ...
    const toDetailView = (text, subject) => {
        navigate(`/circularDetailView`, { state: { heading: text, para: subject } })
        // console.log(name)
    }
            ...
            <BottomContainer>
                ...
                <SideContainer>
                    <FormContainer>
                        ...
                        <TabContainer>
                            {Notify.map((each) => (
                                <Tabs key={each.id} name={each.text}
                                >
                                    <Tab>
                                        <Side onClick={() => toDetailView(each.text, each.subject)}>
                                            <TabIcon><GrAnnounce size={30} /></TabIcon>
                                            <TabNames>
                                                <TabName>{each.text}</TabName>
                                                <TabDate>{each.subject}</TabDate>
                                                {/* <TabDate style={{alignSelf:"flex-end"}}>See More......</TabDate> */}
                                            </TabNames>
                                        </Side>
                                        <TabNames style={{ flexDirection: "row", alignItems: "center" }}>
                                            <TabDate style={{ justifyContent: "flex-end", fontSize: '1rem' }}>{each.date}</TabDate>
